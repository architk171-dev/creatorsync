    ...
    <section id="sample" className="py-20 px-4 gradient-section">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto space-y-4">
          ...
          {/* Verdict */}
          <div className="bg-gradient-to-br from-accent/10 to-card rounded-2xl border border-accent/20 p-6">
          ...
          <div className="bg-card rounded-2xl border border-accent/30 p-8 text-center animate-pulse-glow">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-accent hover:bg-accent-light text-white px-8 py-3 rounded-full font-semibold transition cursor-pointer"
            >
